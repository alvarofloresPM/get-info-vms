...
def windowsinfomaster(master_ip, master_name):
    ...
    m = m.rstrip()
    master_ram = str(m)
    d = s.run_ps('Get-WMIObject -Class Win32_LogicalDisk | Where-Object {$_.DriveType -eq 3} | Select-Object @{n="Unidad";e={($_.Name)}}, @{n="Libre (GB)";e={"{0:n0}" -f ($_.freespace/1gb)}} | Where-Object {$_.Unidad -Match "[CDEZ]"} | Format-List').std_out
    d = d.rstrip()
